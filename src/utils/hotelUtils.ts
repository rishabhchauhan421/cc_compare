...
export class HotelUtils {
  ...
  static getBonvoyMembershipData(
    membershipData: MembershipBonvoy,
  ): MembershipData {
    switch (membershipData) {
  ...
  static getRadissonMembershipData(
    membershipData: MembershipHotelRadisson,
  ): MembershipData {
    switch (membershipData) {
  ...
  static getIPreferMembershipData(
    membershipData: MembershipIPrefer,
  ): MembershipData {
    switch (membershipData) {
  ...
  static getAccorPlusMembershipData(
    membershipData: MembershipAccorPlus,
  ): MembershipData {
    switch (membershipData) {
  ...
  static getHiltonHonorsMembershipData(
    membershipData: MembershipHiltonHonors,
  ): MembershipData {
    switch (membershipData) {
