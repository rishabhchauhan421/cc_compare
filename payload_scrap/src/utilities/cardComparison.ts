import { CardMaterial, CreditCard } from '@prisma/client'
  ...
  static compareCards({
    ...
    switch (attr) {
      ...
      case CreditCardAttributes.isInviteOnly:
        if (card1.isInviteOnly && !card2.isInviteOnly) {
      ...
      case CreditCardAttributes.cardMaterial:
        if (card1.cardMaterial === card2.cardMaterial) {
          return { show: true, isCard1Better: false, isCard2Better: false }
      ...
      case CreditCardAttributes.minAgeSalaried:
        if (card1.minAgeSalaried < card2.minAgeSalaried) {
          return { show: true, isCard1Better: true, isCard2Better: false }
      ...
      case CreditCardAttributes.maxAgeSalaried:
        if (card1.maxAgeSalaried > card2.maxAgeSalaried) {
          return { show: true, isCard1Better: true, isCard2Better: false }
      ...
      case CreditCardAttributes.minNetIncomeSalaried:
        if (card1.minNetIncomeSalaried === card2.minNetIncomeSalaried) {
          return { show: true, isCard1Better: false, isCard2Better: false }
      ...
      case CreditCardAttributes.minAgeSelfEmployed:
        if (card1.minAgeSelfEmployed < card2.minAgeSelfEmployed) {
          return { show: true, isCard1Better: true, isCard2Better: false }
      ...
      case CreditCardAttributes.maxAgeSelfEmployed:
        if (card1.maxAgeSelfEmployed > card2.maxAgeSelfEmployed) {
          return { show: true, isCard1Better: true, isCard2Better: false }
      ...
      case CreditCardAttributes.minNetIncomeSelfEmployed:
        if (card1.minNetIncomeSelfEmployed === card2.minNetIncomeSelfEmployed) {
          return { show: true, isCard1Better: false, isCard2Better: false }
        } else if (card1.minNetIncomeSelfEmployed < card2.minNetIncomeSelfEmployed) {
          return { show: true, isCard1Better: true, isCard2Better: false }
        } else if (card1.minNetIncomeSelfEmployed > card2.minNetIncomeSelfEmployed) {
          return { show: true, isCard1Better: false, isCard2Better: true }
        }
      ...
      case CreditCardAttributes.joiningFee:
        if (card1.joiningFee === 0 && card2.joiningFee === 0)
          return { show: false, isCard1Better: false, isCard2Better: false }
      ...
      case CreditCardAttributes.annualFee:
        if (card1.annualFee === 0 && card2.annualFee === 0)
          return { show: false, isCard1Better: false, isCard2Better: false }
      ...
      case CreditCardAttributes.internationalLounge:
        if (card1.internationalLounge === 0 && card2.internationalLounge === 0)
          return { show: false, isCard1Better: false, isCard2Better: false }
      ...
      case CreditCardAttributes.globalLounge:
        if (card1.globalLounge === 0 && card2.globalLounge === 0)
          return { show: false, isCard1Better: false, isCard2Better: false }
      ...
      case CreditCardAttributes.domesticGuestLounge:
        if (card1.domesticGuestLounge === 0 && card2.domesticGuestLounge === 0)
          return { show: false, isCard1Better: false, isCard2Better: false }
      ...
      case CreditCardAttributes.internationalGuestLounge:
        if (card1.internationalGuestLounge === 0 && card2.internationalGuestLounge === 0)
          return { show: false, isCard1Better: false, isCard2Better: false }
      ...
      case CreditCardAttributes.globalGuestLounge:
        if (card1.globalGuestLounge === 0 && card2.globalGuestLounge === 0)
          return { show: false, isCard1Better: false, isCard2Better: false }
      ...
      case CreditCardAttributes.airportConcierge:
        ...
        if (card1.airportConcierge === card2.airportConcierge)
          return { show: true, isCard1Better: false, isCard2Better: false }
        if (card1.airportConcierge) return { show: true, isCard1Better: true, isCard2Better: false }
        else return { show: true, isCard1Better: false, isCard2Better: true }

      case CreditCardAttributes.domesticGolfGamesPerQuater:
        if (card1.domesticGolfGamesPerQuater === 0 && card2.domesticGolfGamesPerQuater === 0)
          return { show: false, isCard1Better: false, isCard2Better: false }
      ...
      case CreditCardAttributes.internationalGolfGamesPerQuater:
        if (
          ...
          return { show: false, isCard1Better: false, isCard2Better: false }
        if (card1.internationalGolfGamesPerQuater === card2.internationalGolfGamesPerQuater)
          return { show: true, isCard1Better: false, isCard2Better: false }
        if (card1.internationalGolfGamesPerQuater > card2.internationalGolfGamesPerQuater)
          return { show: true, isCard1Better: true, isCard2Better: false }
        else return { show: true, isCard1Better: false, isCard2Better: true }
      ...
      case CreditCardAttributes.membershipTaj:
        var card1Level = HotelUtils.getTajMembershipData(card1.membershipTaj).level
        var card2Level = HotelUtils.getTajMembershipData(card2.membershipTaj).level
      ...
      case CreditCardAttributes.membershipBonvoy:
        var card1Level = HotelUtils.getBonvoyMembershipData(card1.membershipBonvoy).level
        var card2Level = HotelUtils.getBonvoyMembershipData(card2.membershipBonvoy).level
      ...
      case CreditCardAttributes.membershipHotelRadisson:
        var card1Level = HotelUtils.getRadissonMembershipData(card1.membershipHotelRadisson).level
        var card2Level = HotelUtils.getRadissonMembershipData(card2.membershipHotelRadisson).level
      ...
      case CreditCardAttributes.membershipAccorPlus:
        var card1Level = HotelUtils.getAccorPlusMembershipData(card1.membershipAccorPlus).level
        var card2Level = HotelUtils.getAccorPlusMembershipData(card2.membershipAccorPlus).level
      ...
      case CreditCardAttributes.membershipIPrefer:
        var card1Level = HotelUtils.getIPreferMembershipData(card1.membershipIPrefer).level
        var card2Level = HotelUtils.getIPreferMembershipData(card2.membershipIPrefer).level
      ...
      case CreditCardAttributes.introductoryOffers:
        if (card1.introductoryOffers === '' && card2.introductoryOffers === '') {
          return { show: false, isCard1Better: false, isCard2Better: false }
        } else {
          return { show: true, isCard1Better: false, isCard2Better: false }
        }
